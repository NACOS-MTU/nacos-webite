    ...
    return (
        <div className="flex justify-center items-center min-h-screen w-full bg-heroBg bg-black/60 bg-blend-overlay">
            <div className="text-white text-center">
                <h1 className="font-Sora font-bold text-3xl text-primary md:text-4xl lg:text-5xl">Code Traven Hackathon </h1>
                <h1 className="font-Sora font-bold text-3xl md:text-4xl lg:text-4xl">THEME: Local Problems Global Solutiions</h1>
                <p className="mt-3 font-semibold text-primary tracking-wide text-xl">Date: July 2023</p>
