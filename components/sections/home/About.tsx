                ...
                <div className="grid grid-cols-2 items-center">
                    <div className="lg:col-span-1 col-span-2">
                        ...
                        <p className="pt-3 text-justify font-gray-700">
                            ...
                            software engineering, telecommunications engineering and all IT-related courses in Nigeria and have been in existence for over two decades and Nacos can boast of its
